<?php
/*
	Code found via GitHub: https://github.com/hatemzidi/oauth-php-proxy/blob/master/twitter-proxy.php
	Modifications made to better suit this application.
*/
require_once 'config.php';

// The tokens, keys and secrets from the app you created at https://dev.twitter.com/apps
$config = array(
	'oauth_access_token' => $twitterOAuthToken,
	'oauth_access_token_secret' => $twitterOAuthSecret,
